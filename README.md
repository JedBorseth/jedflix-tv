...
**[Download APK](https://github.com/JedBorseth/jedflix-tv/releases/tag/v0.3.1)** · Leanback, API 24+ · sideload only (not on Play Store)
...
2. Install the APK (`adb install jedflix-tv-0.3.1.apk`, or copy onto the TV).
