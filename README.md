...
**[Download APK](https://github.com/JedBorseth/jedflix-tv/releases/tag/v0.4.1)** · Leanback, API 24+ · sideload only (not on Play Store)
...
| Settings | Real-Debrid key on-device (type or QR from phone); Home shelf order and visibility; version and in-app APK updates |
...
2. Install the APK (`adb install jedflix-tv-0.4.1.apk`, or copy onto the TV).
