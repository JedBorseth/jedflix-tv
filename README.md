...
**[Download APK](https://github.com/JedBorseth/jedflix-tv/releases/tag/v0.6.2)** · Leanback, API 24+ · sideload only (not on Play Store)
...
2. Install the APK (`adb install jedflix-tv-0.6.2.apk`, or copy onto the TV).
