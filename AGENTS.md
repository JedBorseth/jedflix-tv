...
- Settings includes a quality profile (Max, Medium, Low). Low disables catalog trailer autoplay and is meant to disable high-res browse images. A focused poster autoplays a hosted 30s MP4 after 5s: the card morphs in-shelf to 16:9, neighbors shift, a transparent folded-J sits bottom-left, and after the clip the wide poster stays until focus leaves. Clips are `{TRAILER_CLIP_BASE_URL}/{youtubeKey}.mp4`.
