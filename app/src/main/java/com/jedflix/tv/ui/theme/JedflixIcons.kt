...
object JedflixIcons {
    ...
    /** Official Letterboxd mark: green, blue, orange overlapping circles. */
    val Letterboxd: ImageVector by lazy {
        ImageVector.Builder(
            name = "Letterboxd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            ...
            .addPath(
                pathData = addPathNodes("M6.5 7a5 5 0 1 0 0 10 5 5 0 1 0 0-10z"),
                fill = SolidColor(Color(0xFF00E054)),
            )
            .addPath(
                pathData = addPathNodes("M12 7a5 5 0 1 0 0 10 5 5 0 1 0 0-10z"),
                fill = SolidColor(Color(0xFF40BCF4)),
            )
            .addPath(
                pathData = addPathNodes("M17.5 7a5 5 0 1 0 0 10 5 5 0 1 0 0-10z"),
